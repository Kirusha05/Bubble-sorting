...
const bubbleSort = (arr) => {
    ...
    // Iterate again and again over the array
		for (let j = 0; j < arr.length - i - 1; j++) { // minus the current cycle num, 'cause the biggest num was moved at the end of the array already, minus one the last index num
      ...
      // Color the current operating numbers in the array
